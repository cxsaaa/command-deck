...
import * as zhCN from "./seedData/zh-CN";
import * as enUS from "./seedData/en-US";
...
export async function seedIfEmpty(db: Database): Promise<void> {
  ...
  const { platforms, categories, commands } = locale === "en-US" ? enUS : zhCN;
