...
const CLI_PREFIXES = [
  "git", "docker", "kubectl", "helm", "npm", "yarn", "pnpm", "npx", "node",
  "python", "pip", "conda", "poetry", "cargo", "rustc", "rustup", "go",
  "curl", "wget", "ssh", "scp", "rsync", "chmod", "chown", "mkdir",
  "rm", "cp", "mv", "ls", "cat", "grep", "awk", "sed", "find", "tar",
  "zip", "unzip", "brew", "apt", "yum", "systemctl", "crontab",
  "openssl", "mysql", "psql", "redis-cli", "mongosh", "aws", "gcloud",
  "az", "terraform", "ansible", "make", "cmake", "docker-compose",
  "podman", "minikube", "kind", "k9s", "stern", "jq", "xargs",
];
